...
class Post(models.Model):
    ...
    likes = models.ManyToManyField(
        User, related_name='like', default=None, blank=True  # All the user who
        # liked our Post
    )

    def get_absolute_url(self):
        return reverse('cars:post_single', args=[self.slug])
...
class Car(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('cars:delete_car', args=[self.pk])
